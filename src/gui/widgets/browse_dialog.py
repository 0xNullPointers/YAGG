...
from PySide6.QtCore import Qt, QByteArray, QAbstractListModel, QModelIndex, QThreadPool, QRunnable, Signal, QObject, QTimer, QSize
...
class ImageLoader(QRunnable):
    ...
    def run(self):
        ...
        self.signals.finished.emit(self.appid, image)
...
class BrowseDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.list_view.setGridSize(QSize(150, 250)) # 120x180 poster + space for text
